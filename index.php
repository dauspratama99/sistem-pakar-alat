...
<head>
    ...
    <title>Diagnosa-KerusakanMesinFotoCopy</title>
...
<div id="art-main">
    ...
    <div class="art-header-inner">
        ...
        <div class="art-logo">
                 <h1 class="art-logo-name">SISTEM PAKAR DIAGNOSA KERUSAKAN <br />MESIN FOTOCOPY</h1>
                         <h2 class="art-logo-text">METODE CASE BASED REASONING (CBR)</h2>
                </div>
    </div>
    </div>
    </div>
