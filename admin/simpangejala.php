...
$gejala=$_POST['gejala'];
$sqlrs=mysqli_query($con,"SELECT kd_gejala FROM gejala WHERE kd_gejala='$kd_gejala'");
...
if($rs==0){
	...
	$berhasil=mysqli_query($con,$perintah) or die (" Data tidak masuk database / data telah ada ".mysqli_error());
	if ($berhasil){
