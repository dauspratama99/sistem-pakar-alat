...
<body>          
<form id="form1" name="form1" method="post" action="edsimkerusakan.php">
<table width="509" border="0" align="center">
  ...
  <tr>
    <td height="39" colspan="3" valign="top"><div align="center">
      <div align="center"><span class="style38"><strong> Edit Kerusakan</strong></span></div></td>
    </tr>
  <tr>
    <td width="160" valign="top"><span class="style35">KD Kerusakan</span></td>
    <td width="9">&nbsp;</td>
  ...
  <tr>
    <td valign="top">Jenis Kerusakan</td>
    <td>&nbsp;</td>
    <td valign="top">
      <label>
  ...
  <tr>
    ...
    <td valign="top"><input type="submit" name="simpan" id="simpan" value="Update" />
     <a href="haladmin.php?top=kerusakan.php"><input type="button" name="batal" id="batal" value="Batal" /></a></td>
      </a></td>
  </tr>
  <tr>
