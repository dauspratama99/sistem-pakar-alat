...
$sql_cek = "SELECT * FROM relasi WHERE kd_kerusakan='$TxtKdPenyakit' AND kd_gejala='$TxtKdGejala'";
...
$qrytes = mysqli_query($con,$sqltes);
while ($data_tmp = mysqli_fetch_array($qrytes)){

$sql  = " INSERT INTO relasi (kd_kerusakan,kd_gejala,bobot) VALUES ('$TxtKdPenyakit','$TxtKdGejala','$bobot')"; 
}
	mysqli_query($con,$sql) or die ("SQL Error".mysqli_error());
