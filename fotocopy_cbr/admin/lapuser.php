...
<body>
<h2 class="art-postheader">Laporan Hasil Diagnosa</h2>
...
<div id="print-area-2" class="print-area">
    <div style="text-align:right;"><a class="no-print" target="_blank" href="../cetak.php?tgl=<?php echo $tanggal; ?>&tgl2=<?php echo $tanggal2; ?>">Cetak Laporan</a></div>
<table  width="100%" border="1" cellpadding="2" cellspacing="1" bgcolor="#22B5DD">
  <tr bordercolor="#CCFFFF" bgcolor="#DBEAF5"> 
    ...
    <td width="100" align="center"><div align="center"><strong>Merk</strong></div></td>
    <td width="235" align="center"><div align="center"><strong>Jenis Kerusakan</strong></div></td>
