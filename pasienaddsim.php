...
elseif (trim($TxtAlamat)=="") {
	...
	$sqldel = "DELETE FROM tmp_pasien WHERE noip='$NOIP'";	mysqli_query($con,$sqldel);
	
	$sql  = " INSERT INTO tmp_pasien (nama,kelamin,merk,alamat,noip,tanggal) 
		 	  VALUES ('$TxtNama','$RbKelamin','$merk','$TxtAlamat','$NOIP',NOW())";
